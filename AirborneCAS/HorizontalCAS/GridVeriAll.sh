...
do
    ...
    do
        python3 gridVeriHCAS.py $pra 20 $phi 0 5 0 &
        python3 gridVeriHCAS.py $pra 20 $phi 1 5 0 &
        python3 gridVeriHCAS.py $pra 20 $phi 2 5 0 &
        python3 gridVeriHCAS.py $pra 20 $phi 3 5 0 &
        python3 gridVeriHCAS.py $pra 20 $phi 4 5 0 &

...
from deepbayesHF.analyzers import prob_veri_intersection
...
p_lower, _ = prob_veri_intersection(bayes_model, img_lower, img_upper, MARGIN, SAMPLES, predicate=predicate_safe, inflate=2.0)
